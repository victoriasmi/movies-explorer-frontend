      ...
      <div className="auth">
        <div className="auth__container">
          ...
          <form className="auth__form auth__form_type_login" >
            ...
            <input className="auth__input auth__input_type_login" id="email-input" type="email" name="email"
              minLength="2" maxLength="30" required />
            {/* value={email ?? ""} onChange={handleEmailChange} /> */}
            <span className="email-input-error error"></span>
            <p className="auth__input-title">Пароль</p>
            <input className="auth__input auth__form_type_register" id="password-input" type="password" name="password" required />
